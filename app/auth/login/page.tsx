    ...
    <main className="min-h-screen bg-gradient-to-b from-amber-50 to-orange-50 flex flex-col items-center justify-center px-6">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-amber-700">Welcome back!</h1>
          <p className="text-gray-500 text-sm mt-1">Sign in to find your walk buddy</p>
        </div>
        ...
        <p className="text-center text-sm text-gray-500 mt-4">
          New here?{' '}
          <Link href="/auth/signup" className="text-amber-600 font-semibold hover:underline">
            Create an account
          </Link>
        </p>
      </div>
